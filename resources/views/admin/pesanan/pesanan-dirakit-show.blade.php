                ...
                <div class="col-12 col-md-8 col-lg-10">
                  <div class="card card-primary">
                        ...
                        <table class="table table-striped mt-3 table-sm">
                            ...
                            <a href="{{route('pesanan-dirakit.index')}}" class="btn btn-outline-primary float-left">Kembali</a>
                            <a href="{{route('pesanan-dirakit.konfirmasi',$pesanan->id)}}" class="btn btn-success float-right btn-sm" >
                                <i class="fas fa-flag-checkered"></i> Selesai</i>
                            </a>
